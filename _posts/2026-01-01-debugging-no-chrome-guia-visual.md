...
![Infográfico sobre Debugging no Chrome: Uma Investigação Visual do Código](/assets/img/1.jpg)
...
![Interface do Console do Google Chrome DevTools](/assets/img/2.jpg)
...
![Comparação entre console.log ineficaz e eficaz](/assets/img/3.jpg)
![Exemplo de visualização com console.table](/assets/img/4.jpg)
...
![Localização da aba Sources no Chrome DevTools](/assets/img/5.jpg)
...
![Como inserir um breakpoint](/assets/img/6.jpg)
![Visualização de execução pausada no Chrome](/assets/img/7.jpg)
...
![Botões de controle de execução no Chrome DevTools](/assets/img/8.jpg)
...
![Inspecionando variáveis com hover](/assets/img/9.jpg)
![Painel Scope no Chrome](/assets/img/10.jpg)
![Painel Watch no Chrome](/assets/img/11.jpg)
